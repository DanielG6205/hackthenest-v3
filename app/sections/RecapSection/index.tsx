            ...
            <div className="flex flex-col space-y-36 pt-36 mx-6 md:mx-0">
                <div className="flex justify-start">
                    <div className="w-full sm:w-5/6 md:w-3/4 rounded-xl overflow-hidden">
                        <FadeInImage src='/recap-page/recap1.png' alt="Image1" />
                    </div>
                ...
                <div className="flex justify-end">
                    ...
                    <div className="w-full sm:w-5/6 md:w-3/4 rounded-xl overflow-hidden">
                        <FadeInImage src='/recap-page/recap2.png' alt="Image4" />
                    </div>

                </div>
                <div className="flex justify-start">
                    <div className="w-full sm:w-5/6 md:w-3/4 rounded-xl overflow-hidden">
                        <FadeInImage src='/recap-page/recap3.png' alt="Image3" />
                    </div>
                ...
                <div className="flex justify-end">
                    ...
                    <div className="w-full sm:w-5/6 md:w-3/4 rounded-xl overflow-hidden">
                        <FadeInImage src='/recap-page/recap4.png' alt="Image2" />
                    </div>
